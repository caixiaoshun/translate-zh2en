...
class PositionEmbedding(nn.Module):
    def __init__(self, embed_dim, max_len):
        ...
        _2i = torch.arange(0, embed_dim, 2)
        pe[:, 0::2] = torch.sin(pos / (10000 ** (_2i / embed_dim)))
        pe[:, 1::2] = torch.cos(pos / (10000 ** (_2i / embed_dim)))
...
class TranslateModelWithAbsolutePositionEmbedding(nn.Module):
    def __init__(
        self,
        vocab_size,
        encoder_layers,
        ...
        self.position_embedding = PositionEmbedding(embed_dim=embed_dim, max_len=max_len)
